export function Aside() {
  return (
    <aside
      id="default-sidebar"
      className="sticky top-0 left-0 z-40 h-screen w-64 -translate-x-full transition-transform sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div className="h-full overflow-visible bg-gray-50 px-3 py-4 dark:bg-gray-800">
